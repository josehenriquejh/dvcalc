...
public class ValidadorCPF {
   ...
   /**
    ...
    public static void main(String[] args) {
     ...
     //public void carregavalorcnpj8(String CNPJ8){}
     //public void carregavalorcnpj12(String CNPJ12){}
    ...
    //System.out.println(CNPJ);
     ...
     if (y14 < 2){
      ...
      y14 = 11 - y14;}
         ...
         //System.out.println("DV8 = " + y13 + ""+ y14);
     ...
     if (y14 < 2){
      ...
      y14 = 11 - y14;}
         ...
         //System.out.println("DV12 = " + y13 + ""+ y14);
     }
    ...
    public boolean validadigitoscnpj12(String CNPJ){
     ...
     public void copytoclipboard(String CPF){
      ...
      public void copytoclipboardcnpj(String CNPJ){
         try{
        StringSelection stringSelection = new StringSelection(CNPJ);
        Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
        clipboard.setContents(stringSelection, null);}
         catch (Exception ex){
         Logger.getLogger(ValidadorCPF.class.getName()).log(Level.SEVERE, null, ex);
